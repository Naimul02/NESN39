...
const RandomProductsInfo = () => {
  ...
  return (
    <div className='bg-slate-100'>
          <div className="bg-[#5fa800] p-12 mx-4 rounded-lg" >
      
      <div className="flex  flex-col lg:flex-row gap-8 bg-white  items-center rounded-lg">

      <div className="w-[45%]">
            <img src="https://cdn.dribbble.com/users/1197989/screenshots/5585685/delivery-boy.gif" className="w-full h-[350px] object-cover rounded-lg" alt="" />
          </div>
